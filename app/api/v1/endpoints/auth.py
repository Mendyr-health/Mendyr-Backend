...
def _set_session_cookies(
    response: Response, tokens: TokenPair, client_platform: str
) -> None:
...
def _clear_session_cookies(response: Response) -> None:
    response.delete_cookie(key=settings.REFRESH_TOKEN_COOKIE_NAME, path="/api")
    response.delete_cookie(key=settings.ACCESS_TOKEN_COOKIE_NAME, path="/api")
